            ...
            >
              {isActive && (
                <motion.div
                  ...
                  className="absolute -top-[1px] w-12 h-1 bg-blue-500 rounded-b-full shadow-[0_2px_10px_rgba(59,130,246,0.5)]"
                />
              )}
              
              <div className="relative">
                  <tab.icon className={`w-6 h-6 ${isActive ? 'fill-blue-500/20' : ''}`} />
